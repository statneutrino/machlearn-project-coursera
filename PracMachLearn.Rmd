...
By using the `varImp` function in the `caret` package, we can identify the most important variables by importance in this particular random forest of a small sample of the data. The most important 20 are printed below using the r command in descending oreder of importance `print(vi$importance[1:20])`.
