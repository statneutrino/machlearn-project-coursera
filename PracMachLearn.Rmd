...
I used a random forest algorithm to create the prediction model. Due to time contraints, and the lengthy processing time with a large number of obervations in the data, I decided to use only 100 trees.
